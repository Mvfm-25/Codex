...
### Cadeiras
- Todas as cadeiras do semestre. Clique no nome da cadeira para ser redirecionado para o índice adequado.
	1. [Projeto Desenvolvimento de Jogos](./pdj/pdj-index.md)
	2. [Projeto & Otimização de Algoritmos](./poa/poa-index.md)
	3. [Sistemas Operacionais](./so/so-index.md)
	4. [Experiência do Usuário](./ux/ux-index.md)
	5. [Métodos Numéricos](./mn/mn-index.md)
	6. [Engenharia De Software](./es2/es2-index.md)

### Entregas - Provas/Trabalhos
- **Abril**
...
- **Maio**
	...
	3. [06/05] **Projeto & Otimização de Algoritmos** - T1.2
	4. [08/05] **Engenharia De Software II** - P1
	5. [14/05] **Métodos Numéricos** - T1
	6. [14/05] **Experiência Do Usuário** - T2
	7. [22/05] **Projeto Desenvolvimento De Jogos** - T2.1
...
---
- **Julho**
	1. [01/07] **Projeto & Otimização de Algoritmos** - P2
	2. [01/07] **Sistemas Operacionais** - T2.1
	3. [02/07] **Métodos Numéricos** - P2
	4. [02/07] **Experiência Do Usuário** - T3.1 
